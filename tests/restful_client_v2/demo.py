...
def hello_milvus(host="127.0.0.1"):
    import time
    # create connection
    connections.connect(host=host, port="19530", token="root:Milvus")
    ...
    default_index = {"index_type": "IVF_FLAT", "metric_type": "L2", "params": {"nlist": 64}}
    print(f"\nCreate index...")
    t0 = time.time()
...
parser.add_argument('--host', type=str, default='10.104.19.72', help='host ip')
