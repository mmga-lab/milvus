...
SUCC = 'succ'
FAIL = 'fail'
DELTA_PER_INS = 10000  # entities per insert
ENTITIES_FOR_SEARCH = 10000  # entities for search_collection
...
DEFAULT_INDEX_PARAM = {"index_type": "AUTOINDEX", "metric_type": "L2", "params": {}}
DEFAULT_SEARCH_PARAM = {"metric_type": "L2", "params": {"search_list": 150}}
