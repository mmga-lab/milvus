...
class TestHelloMilvus(TestcaseBase):
    ...
    def teardown_method(self, method):
        ...
        log.info("[teardown_method] Skip teardown for test case %s..." % method.__name__)
    ...
    def test_milvus_default(self, collection_name):
        ...
        t0 = time.time()
        collection_w = self.init_collection_wrap(name=c_name, active_trace=True)
        tt = time.time() - t0
