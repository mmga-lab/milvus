...
class TestOperations(TestBase):
    ...
    def connection(self, host, port, user, password, milvus_ns, db_name):
    ...
    def init_health_checkers(self, collection_name=None, partition_name=None):
    ...
    def test_operations(self, request_duration, is_check, collection_name):
        ...
        self.init_health_checkers(collection_name=c_name, partition_name=p_name)
