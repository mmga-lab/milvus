...
class Checker:
    ...
    def __init__(self, collection_name=None, partition_name=None, shards_num=1, dim=768, insert_data=False,
...
class SearchChecker(Checker):
    ...
    def search(self):
        res, result = self.c_wrap.search(
            data=cf.gen_vectors(10, self.dim),
