...
from utils.util_k8s import wait_pods_ready, get_milvus_instance_name, get_milvus_deploy_tool, find_activate_coord_pod
...
class TestChaosApply:
    ...
    def test_chaos_apply(self, chaos_type, target_component, chaos_duration, chaos_interval):
        ...
        target_pod_list = find_activate_coord_pod(self.milvus_ns, self.release_name, target_component)
